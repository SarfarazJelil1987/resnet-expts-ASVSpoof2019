...
class SelfAttention(nn.Module):
    ...
    def forward(self, inputs):
        ...
        if self.mean_only:
            ...
            return torch.cat((avg_repr, std_repr), 1)

class PreActBlock(nn.Module):
    """Pre-activation version of the BasicBlock."""
    expansion = 1

    def __init__(self, in_planes, planes, stride, downsample=None, groups=1,
...
class ResNet(nn.Module):
    def __init__(self, num_nodes, enc_dim, resnet_type='18', nclasses=2):
        ...
        layers, block = self.resnet_configs[resnet_type]
        self.in_planes = 16
        self._norm_layer = nn.BatchNorm2d

        # Initial convolution layer
        self.conv1 = nn.Conv2d(1, 16, kernel_size=(9, 3), stride=(4, 1),
        ...
        # Final layers
        self.conv5 = nn.Conv2d(512 * block.expansion, 256,
    ...
    def _make_layer(self, block, planes, num_blocks, stride=1):
        ...
        for _ in range(1, num_blocks):
            layers.append(block(self.in_planes, planes, 1, groups=1,
                              base_width=64, dilation=False,
